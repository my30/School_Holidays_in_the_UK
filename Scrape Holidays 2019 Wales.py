...
filename = 'Scrapped data/School Holidays 2018-2020 Wales.csv'
...
for i in towns:
    ...
    holidays_2020.insert(0, 'Country', 'Wales')
    towns_holidays = holidays_2019.append(holidays_2020, ignore_index=True)
    towns_holidays.to_csv('Scrapped data/School Holidays 2018-2020 Wales.csv', mode='a', header=False)
