...
filename = 'Scrapped data/School Holidays 2018-2019 Northern Ireland.csv'
...
holidays_2019.to_csv('Scrapped data/School Holidays 2018-2019 Northern Ireland.csv', mode='a', header=False)
